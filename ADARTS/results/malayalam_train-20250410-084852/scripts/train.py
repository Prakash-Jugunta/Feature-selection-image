...
parser.add_argument('--drop_path_prob', type=float, default=0.2, help='Drop path probability')  # Add this line
...
# Malayalam dataset configuration
def main():
    ...
    # Model configuration for Malayalam characters
