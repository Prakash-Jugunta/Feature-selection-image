...
dataset_dir = "E:\\sem4\\ML\\project\\NextCode\\malayalam_data"  # Update this to your dataset path
train_dir = "dataset\\malayalam_chars\\train"
test_dir = "dataset\\malayalam_chars\\test"
